import TextPressure from "@/src/components/ui/reactbits/TextPressure";
...
export default function Header() {
    return (
        <div className={"h-fit bg-primary border-[20px] border-background  rounded-[40]"}>
            <div className={"w-full flex flex-row gap-4 p-4 justify-between"}>
            ...
            <div className={"w-full h-full relative flex flex-row "}>
                <div className={"w-full h-full "}>
                    <TextPressure
                        ...
                        minFontSize={10}
                    />
                    {/*<GradientHeading variant="light" size="xxxl" weight="bold">*/}
                    {/*    Bienvenue*/}
                    {/*</GradientHeading>*/}
